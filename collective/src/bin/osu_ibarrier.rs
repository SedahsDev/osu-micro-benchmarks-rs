//! OSU MPI Non-blocking Barrier Latency Test (v7.5.2)
//!
//! Measures non-blocking collective barrier latency using UCX tag-matching
//! barrier fallback. Reports Overlap, CPU, Communication, Wait, and Init
//! times in microseconds.
//!
//! Requires at least 2 processes. Repeatedly calls ibarrier + wait and reports
//! timing breakdown.
//!
//! # Usage
//!
//! ```bash
//! prterun -np 2 ./target/release/osu_ibarrier
//! ```
